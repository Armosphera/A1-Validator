...
"""Vendored from autoresearch-sboss@6e01155a5932a5456995465ae761db8057f87089 — workflow.py.
...
def validate(input_data: dict[str, Any], config: dict[str, Any] | None = None) -> dict[str, Any]:
